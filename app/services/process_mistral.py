...
from app.scrappers.mistral import MistralScrapper
from app.database.repository import Repository

def process_mistral_markdown(limit: Optional[int] = None) -> dict:
  scrapper = MistralScrapper()
  repo = Repository()

  articles = repo.mistral_articles_without_md(limit)
  processed = 0
  failed = 0
...
if __name__ == "__main__":
  result = process_mistral_markdown(2)
